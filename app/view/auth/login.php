...
<html lang="en">
    ...
    <body>
        <div class="container-fluid mt-5 pt-5">
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-5 pt-4">
                        ...
                        <div class="form-group">
                            ...
                            <form action="?aksi=signin" method="post">
                                <div class="form-inline">
                                    <h5 class="form-label form-check-label">username / email</h5>
                                    <input type="text" name="userInput" class="form-control" required
                                        aria-required="true" id="userInput"
                                        placeholder="masukkan username atau email anda ...">
                                </div>
                                <div class="m-3"></div>
                                <div class="form-inline">
                                    <h5 class="form-label form-check-label">kata sandi</h5>
