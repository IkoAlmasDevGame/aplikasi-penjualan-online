...
<html lang="en">
    ...
    <body>
        <div class="container-fluid mt-3 pt-2">
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-2 pt-3">
                <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <form action="?aksi=register" method="post">
                                <div class="form-inline">
                                    ...
                                    <input type="text" name="username" maxlength="80" class="form-control" required
                                ...
                                <div class="form-inline">
                                    ...
                                    <input type="email" name="email" maxlength="128" class="form-control" required
                                        aria-required="true" id="email" placeholder="masukkan email baru anda ...">
                                </div>
                                <div class="m-1"></div>
                                <div class="form-inline">
                                ...
                                <div class="form-inline">
                                    <label for="repassword" class="form-label form-check-label">ulangi kata
                                        sandi</label>
                                    <input type="password" name="repassword" maxlength="128" class="form-control"
                                        required aria-required="true" id="repassword"
                                        placeholder="masukkan repassword anda ...">
                                </div>
                                <div class="m-1"></div>
                                <div class="form-inline">
                                    <label for="alamatInput" class="form-label form-check-label">Alamat</label>
                                    <textarea name="alamat" class="form-control" maxlength="255" id="alamatInput"
                                        required aria-required="true"></textarea>
                                </div>
                                <div class="m-1"></div>
                                <div class="form-inline">
                                    <label for="no_telepon" class="form-label form-check-label">no
                                        telepon</label>
                                    <input type="text" name="no_telepon" class="form-control" maxlength="13" required
                                        aria-required="true" id="no_telepon">
                                </div>
                                <div class="m-1"></div>
                                <div class="form-inline">
                                    <label for="nama_pengguna" class="form-label form-check-label">nama
                                        pengguna</label>
                                    <input type="text" name="nama_pengguna" maxlength="100" class="form-control"
                                        required aria-required="true" id="nama_pengguna"
                                ...
                                <div class="form-inline">
                                    ...
                                    <input type="radio" name="role" class="radio radio-inline" required
                                        aria-required="true" id="title" value="pengguna"> Pengguna
                                </div>
