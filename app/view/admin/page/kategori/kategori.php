            ...
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    ...
                    <div class="text-end mb-1">
                        <a href="../ui/header.php?page=kategori" class="text-decoration-none btn btn-info btn-sm">
                ...
                <div class="card-body">
                    <form action="?aksi=kategori" method="post">
                        <div class="form-group mt-1">
                            <?php if(isset($_GET['id_kategori'])){ 
                                $id = htmlspecialchars($_GET['id_kategori']);
                                $sql = "SELECT * FROM kategori WHERE id_kategori = '$id' order by id_kategori asc";
                            ...
                            <div class="form-inline
                             d-flex justify-content-start align-items-center flex-wrap gap-2">
                                <div class="form-label">
                                    <label for="kategori" class="label label-danger">Nama Kategori</label>
                                </div>
                                <input type="hidden" name="id_kategori" value="<?=$s['id_kategori']?>">
                                <input type="text" name="nama_kategori" value="<?=$s['nama_kategori']?>"
                                    style="width: 25pc;" maxlength="80" class="form-control" id="kategori" required
                                    aria-required="true">
                            ...
                            <div class="form-inline mb-1
                             d-flex justify-content-start align-items-center flex-wrap gap-2">
                                ...
                                <input type="text" name="nama_kategori" style="width: 25pc;" maxlength="80"
                                    class="form-control" id="kategori" required aria-required="true">
                                <button type="submit" class="btn btn-sm btn-primary">
                                    <i class="fa fa-save fa-1x"></i>
                                </button>
                                <button type="reset" class="btn btn-sm btn-danger">
                    ...
                    <div class="table-responsive table-responsive-lg mt-1">
                        ...
                        <table class="table w-100 table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?page=kategori&id_kategori=<?=$isi['id_kategori']?>"
                                            class="btn btn-sm btn-warning">
                                            <i class="fa fa-1x fa-edit"></i>
                                        </a>
                                        <a href="?page=kategori&aksi=kategori&id=<?=$isi['id_kategori']?>"
